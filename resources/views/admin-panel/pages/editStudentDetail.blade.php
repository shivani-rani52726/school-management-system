                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="studentName" class="block text-sm font-medium text-gray-700">Student
                                    Name</label>
                                <input type="text" id="studentName" name="studentName" value="{{ $editStudentDetail->stu_name }}" class="p-2 border rounded w-full" required>
                            </div>
                            <div>
                                <label for="roll_No" class="block text-sm font-medium text-gray-700">Roll Number</label>
                                <input type="number" id="roll_No" name="roll_No" value="{{ $editStudentDetail->rollNo }}" class="p-2 border rounded w-full"
                                   required>
                            </div>
                            <div>
                                <label for="stuClass" class="block text-sm font-medium text-gray-700">Class</label>
                                <input type="text" id="stuClass" name="stuClass" value="{{ $editStudentDetail->class }}" class="p-2 border rounded w-full"
                                   required>
                            </div>
                            <div>
                                <label for="fatherName" class="block text-sm font-medium text-gray-700">Father's
                                    Name</label>
                                <input type="text" id="fatherName" name="fatherName" value="{{ $editStudentDetail->father_name }}" class="p-2 border rounded w-full"
                                    required>
                            </div>
                            <div>
                                <label for="motherName" class="block text-sm font-medium text-gray-700">Mother's
                                    Name</label>
                                <input type="text" id="motherName" name="motherName" value="{{ $editStudentDetail->mother_name }}" class="p-2 border rounded w-full"
                                    required>
                            </div>
                            <div>
                                <label for="aadhaarNo" class="block text-sm font-medium text-gray-700">Aadhaar
                                    Number</label>
                                <input type="number" id="aadhaarNo" name="aadhaarNo" value="{{ $editStudentDetail->aadhar_number }}" class="p-2 border rounded w-full"
                                    required>
                            </div>
                            <div class="col-span-2">
                                <label for="stu_address" class="block text-sm font-medium text-gray-700">Address</label>
                                
                                <textarea id="stu_address" name="stu_address" class="p-2 border rounded w-full" rows="3"
                                    required>{{$editStudentDetail->address}}</textarea>
                            </div>
                            <div class="col-span-2">
                                <label for="contactNo" class="block text-sm font-medium text-gray-700">Contact
                                    Number</label>
                                <input type="text" id="contactNo" name="contactNo" value="{{ $editStudentDetail->contact_number }}" maxlength="10" minlength="10"
