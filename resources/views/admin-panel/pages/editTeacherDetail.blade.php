                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label for="teacherName" class="block text-sm font-medium text-gray-700 mb-1">Teacher
                                    Name</label>
                                <input type="text" id="teacherName" value="{{ $editTeacherDetail->teacher_name }}" name="teacherName" class="p-2 border rounded w-full"
                                     required>
                            </div>
                            <div>
                                <label for="teacherSchoolName"
                                    class="block text-sm font-medium text-gray-700 mb-1">Teacher's School Name</label>
                                <input type="text" id="teacherSchoolName" value="{{ $editTeacherDetail->teacher_school_name }}" name="teacherSchoolName"
                            ...
                            <div>
                                <label for="teacherClass" class="block text-sm font-medium text-gray-700 mb-1">Teacher's
                                    Class</label>
                                <input type="text" id="teacherClass" value="{{ $editTeacherDetail->teacher_class }}" name="teacherClass"
                                    class="p-2 border rounded w-full"  required>
                            </div>
                            <div>
                                <label for="teacherSubject" class="block text-sm font-medium text-gray-700 mb-1">Teacher's
                                    Subject</label>
                                <input type="text" id="teacherSubject" value="{{ $editTeacherDetail->teacher_subject }}" name="teacherSubject"
                                    class="p-2 border rounded w-full"  required>
                            </div>
                            <div>
                                <label for="aadhaarNo" class="block text-sm font-medium text-gray-700 mb-1">Aadhaar
                                    Number</label>
                                <input type="number" id="aadhaarNo" value="{{ $editTeacherDetail->aadhar_no }}" name="aadhaarNo" class="p-2 border rounded w-full"
                                     required>
                            </div>
                            <div>
                                <label for="contactNo" class="block text-sm font-medium text-gray-700 mb-1">Contact
                                    Number</label>
                                <input type="text" id="contactNo" value="{{ $editTeacherDetail->contact_no }}" name="contactNo" maxlength="10" minlength="10"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="teacherAddress" name="teacherAddress" class="p-2 border rounded w-full"
                                    rows="3" required>{{ $editTeacherDetail->address }}</textarea>
                            </div>
                        </div>
